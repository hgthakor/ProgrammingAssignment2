## The functions set below calculate the inverse of a matrix and saves it to the cache such that the next time the user attempts to calculate the
...
## The function set below calculates the inverse of the special "matrix" created with the above function. However, it first checks to see if the inverse
